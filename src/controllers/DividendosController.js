...
export const GetAll = async () => {
  const query = ` SELECT  Id, FundoId, Sigla, Fundo, Cnpj, DtDiv, Ano, Bimestre, Trimestre, Quadrimestre, Semestre, Mes, Dia, MesNome, Qtd, Valor, Total
                  FROM    vDividendos
...
export const SaveItem = async (item) => {
  const query = ` INSERT INTO Dividendos (Id, FundoId, DtDividendo, Qtd, Valor, CreateAt) 
